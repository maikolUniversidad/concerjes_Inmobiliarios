...
import { Building2, User, Shield, Mail, Bell, ChevronRight, IdCard } from 'lucide-react'
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="font-body text-sm text-gray-500 mt-0.5">
            Genera y presenta tu credencial con foto, datos y QR. Descárgala como imagen o PDF.
          </p>
        </div>
