...
const TIPO_META: Record<string, { label: string; color: string }> = {
  ...
  SEDE:                { label: 'Sede cambiada',      color: 'bg-teal-100 text-teal-700' },
  ...
  ENVIO_RESTANTE:      { label: 'Envío restante',     color: 'bg-amber-100 text-amber-800' },
  DEVOLUCION:          { label: 'Devolución',         color: 'bg-amber-100 text-amber-700' },
